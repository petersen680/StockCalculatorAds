...
public class AppRater {
	    private final static String APP_TITLE = "Stock Trade Calc (Pro)";
	    ...
	    public static void showRateDialog(final Context mContext, final SharedPreferences.Editor editor) {
	        ...
	        tv.setText("If you enjoy using this app, you may be interested in purchasing the Pro version, where you can also calculate short trades.");
	        tv.setWidth(240);
