...
public class StockCalculatorSCActivity extends Activity {
       ...
       Button Calculate = (Button) findViewById(R.id.btn_calculate);
        ...
        Calculate.setOnClickListener(new OnClickListener(){
    	    ...
    	    if(price2.doubleValue() == 0 || limitTarget2.doubleValue() == 0 
    	    	...
    	    	Intent i = new Intent("net.dmpetersen.androiddevelopment.StockCalculatorAds.SCERRORSCACTIVITYADS");            
...
protected void showHelp(){
    ...
    protected void calculate(){
       ...
       double r_T_Commission = commission2.doubleValue() + commission2.doubleValue();
       	     ...
       	     Intent i = new Intent("net.dmpetersen.androiddevelopment.StockCalculatorAds.SCRESULTSCACTIVITYADS");            
